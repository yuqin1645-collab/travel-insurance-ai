...
| 承运人延误书面证明 | 改签场景+飞常准查到→推断已满足；描述文本含航班号+延误关键词→推断已满足 |
| 登机牌或电子客票行程单 | 延误证明+身份证明齐全→推断已满足；Vision提取到航班号→推断已提供 |
| 被保险人护照照片页 | 身份证保单+国际航班→推断已提供；证件类型为护照→推断已提供 |
...
| 规则 | 问题 | 影响 |
|------|------|------|
| 登机牌要求 | 延误证明+身份证明齐全时仍要求补件 | 45件被人工放宽 |
| 监护人材料 | claim_info有Relationship字段仍要求补充 | 28件被人工放宽 |
| 延误证明 | 改签场景+飞常准确认仍要求补充 | 3件被人工放宽 |
