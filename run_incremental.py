            ...
            try:
                ...
                try:
                    ...
                    if existing is None:
                        ...
                        LOGGER.info(f"  已注册 claim_status: {forceid} -> downloaded", extra=_log_extra(forceid=forceid, stage="incremental"))
                except Exception as reg_err:
                    LOGGER.warning(f"  claim_status 注册失败 {forceid}: {reg_err}", extra=_log_extra(forceid=forceid, stage="incremental"))
