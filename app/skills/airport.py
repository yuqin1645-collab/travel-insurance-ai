...
_AIRPORT_DB: Dict[str, Dict[str, str]] = {
    ...
    "GYD": {"country_code": "AZ", "country_name": "阿塞拜疆", "timezone": "Asia/Baku", "city": "巴库"},
    ...
    "SVG": {"country_code": "NO", "country_name": "挪威", "timezone": "Europe/Oslo", "city": "斯塔万格"},
    "BGO": {"country_code": "NO", "country_name": "挪威", "timezone": "Europe/Oslo", "city": "卑尔根"},
